...
const Details = () => {
                    ...
                    <div className="grid grid-cols-2 md-lg:grid-cols-1 gap-8">
                        ...
                        <div className="flex flex-col gap-5">
                            ...
                            <div className="flex justify-start items-center gap-4">
                                ...
                                <span className="text-green-500">(24 Avaliações)</span>
                            </div>
                                    ...
                                    <ul className="flex justify-start items-center gap-3">
                                        <li>
                                            <a className="w-[38px] h-[38px] hover:bg-[#059473] hover:text-white
                                             flex justify-center items-center bg-indigo-500 rounded-full text-white"
                                               href="#">
                                                <FaFacebook/>
                                            </a>
                                        </li>
                                        <li>
                                            <a className="w-[38px] h-[38px] hover:bg-[#059473] hover:text-white
                                             flex justify-center items-center bg-cyan-500 rounded-full text-white"
                                               href="#">
                                                <FaTwitter/>
                                            </a>
                                        </li>
                                        <li>
                                            <a className="w-[38px] h-[38px] hover:bg-[#059473] hover:text-white
                                             flex justify-center items-center bg-purple-500 rounded-full text-white"
                                               href="#">
                                                <FaLinkedin/>
                                            </a>
                                        </li>
                                        <li>
                                            <a className="w-[38px] h-[38px] hover:bg-[#059473] hover:text-white
                                             flex justify-center items-center bg-blue-500 rounded-full text-white"
                                               href="#">
                                                <FaGithub/>
                                            </a>
                                        </li>
                            ...
                            <div className="flex gap-3">
                                ...
                                <Link className="px-8 py-3 h-[50px] cursor-pointer hover:shadow-lg
                                        hover:shadow-red-500/40 bg-red-500 text-whitee"
                                      to='#'>Chat com Vendedor</Link>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div className='w-[72%] md-lg:w-full'>
                            <div className='pr-4 md-lg:pr-0'>
                                <div className='grid grid-cols-2'>
                                    <button className={`py-1 hover:text-white px-5 hover:bg-[#059473] ${
                                        state === 'reviews' ? 'bg-[#059473] text-white' : 'bg-slate-700'
                                    } rounded-sm`}
                                            onClick={() => setState('reviews')}>Avaliações
                                    </button>
                                    <button className={`py-1 hover:text-white px-5 hover:bg-[#059473] ${
                                        state === 'description' ? 'bg-[#059473] text-white' : 'bg-slate-200 text-slate-700'
                                    } rounded-sm`}
                                            onClick={() => setState('description')}>Descrição
                                    </button>
                                </div>
                            </div>
    ...
    <section>
        <div className="w-[85%] md:w-[80%] sm:w-[90%] lg:w-[90%] h-full mx-auto">
            <h2 className="text-2xl py-8 text-slate-600">Produtos Recomendados</h2>
            <div>
                <Swiper
                    slidesPerView='auto'
                    breakpoints={{
