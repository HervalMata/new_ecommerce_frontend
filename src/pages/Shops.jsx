    ...
    return (
        <div>
            ...
            <section className='bg-[url("http://localhost:3000/images/banner/shop.png")] h-[220px] mt-6 bg-cover
                ...
                <div className='absolute left-0 top-0 w-full h-full bg-[#2422228A]r'>
            ...
            <section className="py-16">
                <div className='w-[85%] md:w-[80%] sm:w-[90%] lg:w-[90%] h-full mx-auto'>
                    <div className={`md:block hidden ${!filter ? 'mb-6' : 'mb-0'}`}>
                        <button className="text-center w-full py-2 px-3 bg-indigo-500 text-white"
                    ...
                    <div className="w-full flex flex-wrap">
                        <div className={`w-3/12 md-lg:w-4/12 md:w-full pr-8 ${
                            filter ? 'md:h-0 md:overflow-hidden md:mb-6' : 
                                'md:h-auto md:overflow-auto md:mb-0'
                        }`}>
                            <h2 className="text-3xl font-bold">Categoria</h2>
                            <div className="py-2">
                                {
                                    categories.map((c,i) =>
                            ...
                            <div className="py-2 flex flex-col gap-5">
                                <h2 className="text-3xl font-bold mb-3 text-slate-600">Preço</h2>
                                <Range
                                    step={5}
                                    min={50}
                                    max={1500}
                            ...
                            <div className="py-5 flex flex-col gap-4 md:hidden">
                                <Products title='ùltimos Produtos' />
                            </div>
                        </div>
