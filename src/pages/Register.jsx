...
const Register = () => {
    ...
    return (
        <div>
            {
                loader &&
                <div className="w-screen h-screen flex justify-center items-center fixed left-0 top-0
                              bg-[#38303033] z-[999]">
                    <FadeLoader />
                </div>
            }
                    ...
                    <div className="grid grid-cols-2 w-[60%] mx-auto bg-white rounded-md">
                        ...
                        <div>
                            <form className="text-slate-600" onSubmit={register}>
                                <div className="flex flex-col gap-1 mb-2">
                                    ...
                                    focus:border-green-500 rounded-md' type="text" id="name" name="name"
                                ...
                                <div className="flex flex-col gap-1 mb-2">
                                    ...
                                    <input onChange={inputHandle} value={state.email}
                                        className='w-full px-3 py-2 border border-slate-200 outline-none
                                    focus:border-green-500 rounded-md' type="text" id="email" name="email"
                                ...
                                <div className="flex flex-col gap-1 mb-2">
                                    ...
                                    <input onChange={inputHandle} value={state.password}
                                        className='w-full px-3 py-2 border border-slate-200 outline-none
                                    focus:border-green-500 rounded-md' type="password" id="password" name="password"
                                           placeholder="Senha" required />
                                </div>

                                <button className="px-8 w-full bg-[#059473] shadow-lg hover:shadow-green-500/40
                                          text-white rounded-md">Cadastrar</button>
                            </form>
                            ...
                            <button className='px-8 w-full py-2 bg-red-500 shadow hover:shadow-red-500/50
                                  text-white rounded-md flex justify-center items-center gap-2 mb-3'>
                                <span><FaGoogle /></span>
                        ...
                        <div className="text-center text-slate-600 pt-1">
                            <p>Você não tem conta?
                                <Link className="text-blue-500" to="/login"> Entrar</Link>
                            </p>
                        </div>
                    </div>
