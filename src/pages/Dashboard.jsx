                        ...
                        <div className={`rounded-md z-50 md-lg:absolute ${
                            ...
                            <ul className="py-2 text-slate-600 px-4">
                                ...
                                <li className="flex justify-start items-center gap-2 py-2">
                                    ...
                                    <Link to="/dashboard/my-orders" className="block">Minhas Ordens </Link>
                                </li>
                                <li className="flex justify-start items-center gap-2 py-2">
                                    <span className="text-xl"><FaHeart /></span>
                                    <Link to="/dashboard/my-wishlist" className="block">Lista de Desejos </Link>
                                </li>
                                <li className="flex justify-start items-center gap-2 py-2">
                                ...
                                <li className="flex justify-start items-center gap-2 py-2">
                                    ...
                                    <Link to="/dashboard/change-password" className="block">Alterer Senha </Link>
                                </li>
                                <li className="flex justify-start items-center gap-2 py-2">
                                    <span className="text-xl"><IoMdLogOut /></span>
                                    <Link to="/dashboard" className="block">Sair </Link>
                                </li>
                            </ul>
                        </div>
