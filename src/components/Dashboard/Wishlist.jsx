                ...
                wishlist.map((p, i) =>
                    <div key={i} className="border group transition-all duration-500 hover:shadow-md hover:mt-3 bg-white">
                        <div className="relative overflow-hidden">
                                ...
                                {
                                    p.discount !== 0 &&
                                    <div className="flex justify-center items-center absolute text-white w-[38px] h-[38px]
                                         rounded-full bg-red-500 font-semibold text-xs left-2 top-2">
                                        {p.discount}%
                                    </div>
                                }
                            ...
                            <ul className="flex transition-all duration-700 -bottom-10 justify-center items-center
                                ...
                                <li onClick={() => dispatch(remove_wishlist(p._id))}
                                    className="w[45px] h-[25px] cursor-pointer bg-white flex justify-center
                                               items-center rounded-full hover:bg-[#059473] hover:text-white
                                               hover:rotate-[720deg] transition-all">
                                    <FaRegHeart />
                                </li>
                                <Link to={`/product/details/${p.slug}`}
                                      className="w[50px] h-[25px] cursor-pointer bg-white flex justify-center
                                               items-center rounded-full hover:bg-[#059473] hover:text-white
                                               hover:rotate-[720deg] transition-all">
                                    <FaEye />
                                </Link>
                                <li className="w[50px] h-[25px] cursor-pointer bg-white flex justify-center
                                               items-center rounded-full hover:bg-[#059473] hover:text-white
                                               hover:rotate-[720deg] transition-all">
                                    <RiShoppingCartLine />
                                </li>
                        ...
                        <div className="py-3 text-slate-600 px-2">
                            ...
                            <div className="flex justify-start items-center gap-3">
                                <span className="text-md font-semibold">
                                    RS {p.price.toLocaleString('pr-BR', {minimumFractionDigits: 2})}
                                </span>
                                <div className="flex">
